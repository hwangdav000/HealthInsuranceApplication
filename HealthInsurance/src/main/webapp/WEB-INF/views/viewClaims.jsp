...
United States
    ...
    <!-- View Claim Items Modal-->
    <div class="modal" id="viewClaimModal">
	    <div class="modal-dialog modal-lg">
	        <div class="modal-content">
	            <!-- Modal Header -->
	            <div class="modal-header">
	                <h4 class="modal-title">View Claim Items</h4>
	            ...
	            <!-- Modal body -->
	            <div class="modal-body" id="viewClaimModal_modalBody" style="overflow: auto; height: 400px">
	                <!-- put content here -->
	            </div>
    ...
    <script src="js/viewClaims.js"></script>
</body>
