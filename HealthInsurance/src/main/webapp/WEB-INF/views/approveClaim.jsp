...
United States
    ...
    <div class="container" style="margin-top:200px;">
      <div class="approveClaim-body">
        <div class="d-flex justify-content-center">
          <div id="approveClaim-table" class="mt-3">
            <table class="table table-striped">
              ...
              <tbody id="aproveClaim-table-body"></tbody>
            </table>
          </div>
        </div>
      </div>
...
<footer class="fixed-bottom">
    ...
    <!-- View Claim Items Approve Modal-->
    <div class="modal" id="claimApproveModal">
	    <div class="modal-dialog modal-lg">
	        <div class="modal-content">
	            <!-- Modal Header -->
	            <div class="modal-header">
	                <h4 class="modal-title">Review Claim Items</h4>
	            ...
	            <!-- Modal body -->
	            <div class="modal-body" id="claimApproveModal_modalBody" style="overflow: auto; height: 400px">
	                <!-- put content here -->
	            </div>
    ...
    <script src="js/approveClaim.js"></script>
